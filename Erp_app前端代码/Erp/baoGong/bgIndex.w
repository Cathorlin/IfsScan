...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
   ...
   <ul xid="ul1">
    <li class="list-group-item" xid="li1">
     <div class="input-group" component="$UI/system/components/bootstrap/inputGroup/inputGroup" xid="inputGroup1">
      ...
      <input type="text" component="$UI/system/components/justep/input/input" xid="soInfo" placeHolder="请输入车间订单号或扫码录入" class="form-control" valueUpdateMode="keypress"></input></div> </li>
  ...
  <tr xid="tr1"><td xid="td3" style="width:50%;">
  ...
  <tr xid="tr4"><td xid="td2" style="width:50%;">
   <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="提交" xid="button1" style="width:100%;" onClick="submitBtnClick">
    <i xid="i3"></i>
    <span xid="span6">提交</span></a> </td></tr></table></li>
   </ul> 
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="bgLineInfoDialog" src="$UI/Erp/baoGong/bgLineInfo.w" routable="true"></span></div>
