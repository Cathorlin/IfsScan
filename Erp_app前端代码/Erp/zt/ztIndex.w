...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
   ...
   <ul xid="ul1">
    <li class="list-group-item" xid="li1">
     <div class="input-group" component="$UI/system/components/bootstrap/inputGroup/inputGroup" xid="inputGroup1">
      <span xid="span2" style="background-color:#FFFFFF;" class="input-group-addon"><![CDATA[托盘号：]]></span>
      <input type="text" component="$UI/system/components/justep/input/input" xid="tpNo" placeHolder="请输入托盘号或扫码录入" class="form-control" valueUpdateMode="keypress"></input></div> </li>
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="ztLineDialog" src="$UI/Erp/zt/ztLine.w"></span></div>
