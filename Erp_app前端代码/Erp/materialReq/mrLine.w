...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="mrLineData" idColumn="part_no"><column label="零件号" name="part_no" type="String" xid="xid1"></column>
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="mrLineInfoDialog" src="$UI/Erp/materialReq/mrLineInfo.w" onReceive="mrLineDialogReceive" routable="true"></span><div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" title="材料申请单"
          class="x-titlebar">
          ...
          <div class="x-titlebar-title">材料申请单</div>  
   ...
   <div component="$UI/system/components/justep/output/output" class="x-output center-block x-edit" xid="mrId"></div></div>
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit3">
   <label class="x-label" xid="label3" style="text-align:right;"><![CDATA[内部客户号：]]></label>
   <div component="$UI/system/components/justep/output/output" class="x-output center-block x-edit" xid="customerNo"></div></div>
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit2">
   <label class="x-label" xid="label2" style="text-align:right;"><![CDATA[客户名称：]]></label>
   <div component="$UI/system/components/justep/output/output" class="x-output center-block x-edit" xid="customerName"></div></div></li> 
  ...
  <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true" responsive="true" rowActiveClass="active" class="table table-hover table-striped" xid="dataTables1" data="mrLineData" style="font-size:xx-small;" ordering="false">
