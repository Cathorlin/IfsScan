...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1" style="background-color:#F2F2F2;"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" title="生产报工"
          class="x-titlebar">
          ...
          <div class="x-titlebar-title">生产报工</div>  
   ...
   <ul xid="ul1">
    <li class="list-group-item" xid="li1">
     <div class="input-group" component="$UI/system/components/bootstrap/inputGroup/inputGroup" xid="inputGroup1">
      <span xid="span2" style="background-color:#FFFFFF;" class="input-group-addon"><![CDATA[生产订单号：]]></span>
      <input type="text" component="$UI/system/components/justep/input/input" xid="soId" placeHolder="请输入车间订单号或扫码录入" class="form-control" valueUpdateMode="keypress"></input></div> </li>
  
  	<li class="list-group-item" xid="li5">
   <div class="input-group" component="$UI/system/components/bootstrap/inputGroup/inputGroup" xid="inputGroup2">
    <span xid="span3" style="background-color:#FFFFFF;" class="input-group-addon"><![CDATA[生产工序号：]]></span>
    <input type="text" component="$UI/system/components/justep/input/input" xid="operationNo" placeHolder="请输入生产工序号或扫码录入" class="form-control" valueUpdateMode="keypress"></input></div> </li><li class="list-group-item" xid="li2">
     
  <table component="$UI/system/components/bootstrap/table/table" xid="table1" class="table">
   
   
  <tr xid="tr3"><td xid="td5" style="width:50%;"><a component="$UI/system/components/justep/button/button" class="btn btn-default" label="扫描生产订单号" xid="scanBtn" style="width:100%" onClick="scanBtnClick" disabled="true">
   <i xid="i4"></i>
   <span xid="span5">扫描生产订单号</span></a></td>
  <td xid="td3" style="width:50%;">
   <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="扫描工序号" xid="button2" style="width:100%" onClick="button2Click" disabled="true">
    <i xid="i6"></i>
    <span xid="span7">扫描工序号</span></a> </td></tr>
  <tr xid="tr4"><td xid="td2" style="width:50%;">
   <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="交件" xid="jiaojian" style="width:100%;" onClick="jiaojianBtnClick">
    <i xid="i3"></i>
    <span xid="span6">交件</span></a> </td>
  <td xid="td1" style="width:50%;">
   <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="接件" xid="jiejian" style="width:100%;" onClick="jiejianBtnClick">
    <i xid="i1"></i>
    <span xid="span1">接件</span></a> </td></tr></table></li>
   </ul> 
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="jiaojianInfoDialog" src="$UI/Erp/jiaoJie/jiaoLineInfo.w" routable="true"></span>
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="jiejianInfoDialog" src="$UI/Erp/jiaoJie/jieLineInfo.w" routable="true"></span></div>
