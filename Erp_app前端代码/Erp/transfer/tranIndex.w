...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1" style="background-color:#F2F2F2;"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" title="移库"
          class="x-titlebar">
          ...
          <div class="x-titlebar-title">移库</div>  
   ...
   <ul xid="ul1">
    <li class="list-group-item" xid="li1">
     <div class="input-group" component="$UI/system/components/bootstrap/inputGroup/inputGroup" xid="inputGroup1">
      <span xid="span2" style="background-color:#FFFFFF;" class="input-group-addon"><![CDATA[运输任务号：]]></span>
      <input type="text" component="$UI/system/components/justep/input/input" xid="tranId" placeHolder="请输入运输任务号或扫码录入" class="form-control" valueUpdateMode="keypress"></input></div> </li>
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="tranLineDialog" src="$UI/Erp/transfer/tranLine.w" routable="true"></span></div>
