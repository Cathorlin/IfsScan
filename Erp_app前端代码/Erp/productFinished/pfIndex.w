...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1" style="background-color:#F2F2F2;"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" title="成品入库"
          class="x-titlebar">
          ...
          <div class="x-titlebar-title">成品入库</div>  
   ...
   <ul xid="ul1">
    <li class="list-group-item" xid="li1">
     <div class="input-group" component="$UI/system/components/bootstrap/inputGroup/inputGroup" xid="inputGroup1">
      ...
      <input type="text" component="$UI/system/components/justep/input/input" xid="soId" placeHolder="请输入生产订单号或扫码录入" class="form-control" valueUpdateMode="keypress"></input></div> </li>
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="pfLineInfoDialog" src="$UI/Erp/productFinished/pfLineInfo.w" routable="true"></span></div>
