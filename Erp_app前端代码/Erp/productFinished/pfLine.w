...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <column label="数量" name="qty" type="String" xid="column4"></column>
  <column label="库位" name="location" type="String" xid="xid1"></column></div></div>  
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="pfLineInfoDialog" src="$UI/Erp/productFinished/pfLineInfo.w" onReceive="pfLineDialogReceive" routable="true"></span><div component="$UI/system/components/justep/panel/panel" 
  ...
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit2">
   ...
   <div component="$UI/system/components/justep/output/output" class="x-output center-block x-edit" xid="part_desc"></div></div>
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit5">
   <label class="x-label" xid="label5" style="text-align:right;"><![CDATA[批量大小：]]></label>
   <div component="$UI/system/components/justep/output/output" class="x-output center-block x-edit" xid="qty"></div></div>
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit6">
   <label class="x-label" xid="label6" style="text-align:right;"><![CDATA[开始日期：]]></label>
   <div component="$UI/system/components/justep/output/output" class="x-output center-block x-edit" xid="start_date"></div></div>
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit7">
   <label class="x-label" xid="label7" style="text-align:right;"><![CDATA[结束日期：]]></label>
   <div component="$UI/system/components/justep/output/output" class="x-output center-block x-edit" xid="end_date"></div></div></li> 
    ...
    <table component="$UI/system/components/bootstrap/table/table" xid="table1" class="table">
     <tr xid="tr3">
      ...
      <td xid="td6" style="width:50%;">
       <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="确认入库" xid="submitBtn" style="width:100%;" onClick="submitBtnClick">
        <i xid="i1"></i>
        <span xid="span1">确认入库</span></a> </td> </tr> </table> </li> <li class="list-group-item" xid="li6">
   ...
   <div component="$UI/system/components/justep/output/output" class="x-output x-edit" xid="output2" bind-ref='ref("qty")'></div></div>
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit8">
   <label class="x-label" xid="label8" style="text-align:right;color:#C0C0C0;"><![CDATA[库位：]]></label>
   <div component="$UI/system/components/justep/output/output" class="x-output x-edit" xid="output5" bind-ref='ref("location")'></div></div></li> </div> </div> </div> </ul> </div> </li></ul>
  </div>
  </div> 
</div>