...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
   ...
   <ul xid="ul1">
    <li class="list-group-item" xid="li1">
     <div class="input-group" component="$UI/system/components/bootstrap/inputGroup/inputGroup" xid="inputGroup1">
      <span xid="span2" style="background-color:#FFFFFF;" class="input-group-addon"><![CDATA[盘点报告号：]]></span>
      <input type="text" component="$UI/system/components/justep/input/input" xid="countId" placeHolder="请输入盘点报告号或扫码录入" class="form-control" valueUpdateMode="keypress"></input></div> </li>
   ...
   <div class="input-group" component="$UI/system/components/bootstrap/inputGroup/inputGroup" xid="inputGroup2">
    <span xid="span3" style="background-color:#FFFFFF;" class="input-group-addon"><![CDATA[仓库货位号：]]></span>
    <input type="text" component="$UI/system/components/justep/input/input" xid="location" placeHolder="请输入仓库货位号或扫码录入" class="form-control" valueUpdateMode="keypress"></input></div> </li><li class="list-group-item" xid="li2">
     
  <table component="$UI/system/components/bootstrap/table/table" xid="table1" class="table">
   
   
  <tr xid="tr3"><td xid="td5" style="width:50%;"><a component="$UI/system/components/justep/button/button" class="btn btn-default" label="扫描盘点报告号" xid="scanBtn" style="width:100%" onClick="scanBtnClick" disabled="true">
   <i xid="i4"></i>
   <span xid="span5">扫描盘点报告号</span></a></td>
  </tr>
  <tr xid="tr1"><td xid="td3" style="width:50%;">
   <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="扫描货位号" xid="button2" style="width:100%" onClick="button2Click" disabled="true">
    <i xid="i6"></i>
    <span xid="span7">扫描货位号</span></a> </td></tr>
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="countLineDialog" src="$UI/Erp/counting/countLine.w" routable="true"></span></div>
